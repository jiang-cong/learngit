<template>
    <div id="app">
        ...
        <i-col :xs="24" :sm="24" :md="18" :lg="20">
            ...
            <!-- <div class="content-table" v-if="cut==2">
                 <Table border :columns="columns1" :data="data2"></Table>
                  <div class="page" v-if="pd1">
...
export default {
    ...
    methods:{
        ...
        page(num){//基础交通项目的切换页
         ...
         page2(num){//智慧交通项目的切换页
          ...
          axios(pageNum,pageSize){//智慧交通项目
            this.$axios.get(`/build/selectall?buildNum=ZN&pageNum=${pageNum}&pageSize=${pageSize}&statusNum=43`).then(res=>{
                // console.log(res)
                 this.data1 = [];
        ...
        axios2(pageNum,pageSize){//基础交通项目
            this.$axios.get(`/build/selectall?buildNum=JC&pageNum=${pageNum}&pageSize=${pageSize}&statusNum=43`).then(res=>{
                console.log(res)
                this.data1 = [];
                var newarr = res.data.list;
                this.total = res.data.total;
